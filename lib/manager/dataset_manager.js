    ...
    async processStaticGTFS(index, dataset) {
        ...
        try {
            ...
            if (file_name != null) {
                ...
                let converter = new Connections({ format: 'jsonld', store: 'KeyvStore', baseUris: baseURIs });
                ...
                converter.resultStream(uncompressed_feed, connsPath, async rawConns => {
                    ...
                    await del([this.storage + '/datasets/' + companyName + '/' + file_name + '_tmp'], { force: true });
                    ...
                    reader.pipe(new jsonldstream.Deserializer())
                        ...
                        .on('finish', async () => {
                            ...
                            let [catalog, stops, routes] = await Promise.all([
                                ...
                                new Stops().createStopList(),
                                new Routes().createRouteList(),
                            ]);
                            await Promise.all([
