...
class PageFinder {
    async getConnections(req, res) {
        ...
        try {
            ...
            if (rt_exists) {
                if (utils.handleConditionalGET(req, res, accept, rtfs[rtfs.length - 1], true, departureTime)) {
                    return;
                }
            } else {
                if (utils.handleConditionalGET(req, res, accept, sf_path, false, departureTime)) {
                    return;
                }
            }
