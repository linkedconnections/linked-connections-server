...
export class Utils {
    ...
    constructor() {
        ...
        logger = getLogger(this._serverConfig.logLevel || 'info');
    }
    ...
    resolveRDFJSTerm(term) {
        switch (term.termType) {
            ...
            case 'BlankNode':
                return df.blankNode(term.value.substring(2));
            case 'Literal':
                return df.literal(term.value, df.namedNode(term.datatype.value));
            case 'DefaultGraph':
