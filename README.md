...
[![Build Status](https://travis-ci.com/julianrojas87/linked-connections-server.svg?branch=master)](https://travis-ci.com/julianrojas87/linked-connections-server.svg?branch=master) [![Coverage Status](https://coveralls.io/repos/github/julianrojas87/linked-connections-server/badge.svg?branch=development)](https://coveralls.io/github/julianrojas87/linked-connections-server?branch=development) [![Greenkeeper badge](https://badges.greenkeeper.io/julianrojas87/linked-connections-server.svg)](https://greenkeeper.io/)
